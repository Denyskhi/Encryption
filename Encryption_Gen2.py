...
def generatePass(length):
    ...
    newPas = p.get()
    if(newPas != None and newPas != ""):
        for i in range(0, len(newPas) - 1):
            for x in range(i+1, len(newPas)):
                try:
                    if(newPas[i] == newPas[x]):
                        newPas = newPas[:x] + newPas[x+1:]
                except:
                    x = x
        return newPas
    l = 1
...
tk.mainloop()
#1119 1185 1166 1204 1175 1169 1166 1161 140 1146 119 131 151 1174 1187 1192 1190 1157 
#ClfYw_PWc
#132 87 80 82 142 133 148 137 149 160 207 210 132 123 188 137